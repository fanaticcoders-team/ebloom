            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  {{-- <div class="test-part">
                    <h3>Πως κάνω παραγγελία από την ebloom;</h3><br>
                    <p>Η διαδικασία της παραγγελίας από την ebloom είναι πολύ απλή, εύκολη και γρήγορη! <br>
                      1. Ξεκινάτε κάνοντας μια αναζήτηση στην πλατφόρμα της ebloom για ανθοπωλεία που βρίσκονται κοντά σας. </p>
                    <p>2. Αφού ολοκληρωθεί, επιλέγετε τα προϊόντα που προτιμάτε (λουλούδια, ανθοδέσμες, συνθέσεις, φυτά κλπ.) από το κατάστημα που σας εξυπηρετεί. </p>
                    <p>3. Τέλος, καταχωρείτε την παραγγελία σας. </p>
                  </div> --}}
                  <h3>
                    {{__('protection.Ποιοι είναι οι νόμιμοι λόγοι επεξεργασίας των προσωπικών σας δεδομένων')}}
                </h3>
                <p>
                  {{__('protection.Νόμιμοι λόγοι επεξεργασίας των προσωπικών σας δεδομένων συνιστούν:')}}
                </p>
                <p>

                  {{__('protection.(α) η παροχή των υπηρεσιών που μας αναθέτετε και επιθυμείτε να λάβετε εμάς όπως για παράδειγμα η αγορά προϊόντων και κατά συνέπεια η εκπλήρωση των συμβατικών μας υποχρεώσεων στο πλαίσιο αυτό')}}
                </p>
                <p>

                  {{__('protection.(β) η διαφύλαξη και προστασία των εννόμων συμφερόντων, τόσο των δικών σας όσο και των δικών μας.')}}
                </p>
                <p>

                  {{__('protection.(γ) η συμμόρφωση με υποχρέωση που επιβάλλεται από το νόμο, όπως κανονιστική συμμόρφωση για φορολογικούς σκοπούς')}}
                </p>
                <p>

                  {{__('protection.(δ) η συγκατάθεση που παρέχετε υπό τις συγκεκριμένες προϋποθέσεις που θέτει το νομικό πλαίσιο, προκειμένου να λαμβάνετε ενημερώσεις για προϊόντα, υπηρεσίες, προσφορές κ.α. οι οποίες επεξεργάζονται προσωπικά δεδομένα σύμφωνα με το ισχύον κάθε φορά πλαίσιο')}}
                </p>
                {{--  --}}
                <h3> {{__('protection.Πώς και γιατί χρησιμοποιούμε τα προσωπικά δεδομένα σας Δημιουργία Λογαριασμού και σαν Guest')}}</h3>
                <p>
                  {{__('protection.Προσωπικά δεδομένα συλλέγονται όταν δημιουργείτε λογαριασμό στην www.ebloom.gr. Κατά τη δημιουργία λογαριασμού μπορεί να σας ζητηθούν περισσότερα στοιχεία, ωστόσο τα ελάχιστα για τη σύναψη και εκτέλεση της σύμβασης θα έχουν τη σήμανση υποχρεωτικού πεδίου')}}.</p>
                <p>
                    
                  {{__('protection.Επίσης, δημιουργώντας λογαριασμό στην www.ebloom.gr μπορείτε να επεξεργαστείτε τα δεδομένα να προσθέσετε ή να αφαιρέσετε στοιχεία. Τα στοιχεία αυτά θα χρησιμοποιηθούν για να γίνει η διαδικασία της ολοκλήρωσης παραγγελίας πιο εύκολη κάθε φορά που θα επισκέπτεστε το ηλεκτρονικό μας κατάστημα μας και επιλέγετε να είστε συνδεδεμένοι.')}} </p>
                <p>
                  {{__('protection.Τα παραπάνω στοιχεία είναι απαραίτητα για την αποστολή (διεύθυνση - τηλέφωνο-αριθμός-ΤΚ κ.λ.π) για την παράδοση της παραγγελίας σας από τα συνεργαζόμενα καταστήματα και την έκδοση του παραστατικού που θα επιλέξετε (Απόδειξη ή Τιμολόγιο).')}}
                </p>

                <h3> {{__('protection.Εκτέλεση - Αποστολή Παραγγελίας')}} </h3>
                <p>
                    
                  {{__('protection.Προσωπικά δεδομένα συλλέγονται και όταν κάνετε παραγγελία στην www.ebloom.gr.  Για την ολοκλήρωση της παραγγελίας σας και της δημιουργίας λογαριασμού μπορεί να σας ζητηθούν περισσότερα στοιχεία, ωστόσο θα είναι τα ελάχιστα για τη σύναψη και εκτέλεση της σύμβασης. Τα εν λόγω στοιχεία έχουν τη σήμανση υποχρεωτικού πεδίου.')}}
                </p>
                <p>
                  {{__('protection.Στα πλαίσια της ολοκλήρωσης της παραγγελίας κάποια από τα δεδομένα αυτά μεταφέρονται στα συνεργαζόμενα καταστήματα/προμηθευτές. Ως εκ τούτου, μεταφέρονται σε τρίτες εταιρείες για τη μεταφορά και παράδοση των προϊόντων σας. Oι εταιρείες αυτές ενδέχεται να επικοινωνήσουν μαζί σας για να ζητήσουν διευκρινήσεις αλλά και να σας ενημερώσουν για την παράδοση της παραγγελίας σας. Επιπλέον, τα δεδομένα μεταβιβάζονται κατά την εκτέλεση πληρωμής σε παρόχους πληρωμών.')}}
                </p>
                <p>
                  {{__('protection.Η Εταιρεία  χρησιμοποιεί συστήματα αυξημένης ασφαλείας για αποφυγή διαρροής στων στοιχείων από κακόβουλα συστήματα.')}}
                </p>  
                {{--  --}}
                <h3> {{__('protection.Χρονικό Διάστημα Αποθήκευσης')}}
                </h3>
                <p>
                  {{__('protection.Το χρονικό διάστημα αποθήκευσης των δεδομένων αποφασίζεται με βάση τα παρακάτω ειδικότερα κριτήρια ανάλογα με την περίπτωση:')}}
                </p>
                <p>
                  {{__('protection.Όταν η επεξεργασία επιβάλλεται ως υποχρέωση από διατάξεις του ισχύοντος νομικού πλαισίου, τα προσωπικά σας δεδομένα θα αποθηκεύονται για όσο χρονικό διάστημα επιβάλλουν οι σχετικές διατάξεις.')}}
                </p>
                <p>
                  {{__('protection.Όταν η επεξεργασία εκτελείται με βάση σύμβαση, τα προσωπικά σας δεδομένα αποθηκεύονται για όσο χρονικό διάστημα είναι απαραίτητο για την εκτέλεση της σύμβασης και για τη θεμελίωση, άσκηση, ή/και υποστήριξη νομικών αξιώσεων με βάση τη σύμβαση.')}}
                </p>
                <p>
                  {{__('protection.Για τους σκοπούς προώθησης προϊόντων και υπηρεσιών, τα προσωπικά σας δεδομένα τηρούνται μέχρι την ανάκληση της συγκατάθεσης σας. Αυτό μπορεί να πραγματοποιηθεί από εσάς οποιαδήποτε στιγμή. Η ανάκληση της συγκατάθεσής δεν θίγει τη νομιμότητα της επεξεργασίας που βασίστηκε στη συγκατάθεση κατά το χρονικό διάστημα πριν την ανάκλησή της.')}}
                </p>        
                
                <h3> {{__('protection.Ποια είναι τα δικαιώματα σας σε σχέση με τα προσωπικά σας δεδομένα')}}
                </h3>
                <p>
                <strong> {{__('protection.Δικαίωμα πρόσβασης:')}} </strong>
                {{__('protection.Έχετε δικαίωμα να έχετε επίγνωση και να επαληθεύετε τη νομιμότητα της επεξεργασίας. Έτσι λοιπόν, έχετε δικαίωμα να έχετε πρόσβαση στα δεδομένα και να λάβετε συμπληρωματικές πληροφορίες σχετικά με την επεξεργασία τους.')}}
                </p>
                <p>
                <strong> {{__('protection.Δικαίωμα διόρθωσης:')}} </strong> {{__('protection.Έχετε δικαίωμα να μελετήσετε, να διορθώσετε, να τροποποιήσετε τα προσωπικά σας δεδομένα')}}
                </p>
                <p>

                  <strong> {{__('protection.Δικαίωμα διαγραφής:')}} </strong> {{__('protection.Έχετε δικαίωμα να υποβάλετε αίτημα διαγραφής των προσωπικών σας δεδομένων όταν τα επεξεργαζόμαστε με βάση την συγκατάθεσή σας ή με προκειμένου να προστατεύσουμε τα έννομα συμφέροντα μας. Σε όλες τις υπόλοιπες περιπτώσεις (όπως ενδεικτικά όταν υπάρχει σύμβαση, υποχρέωση επεξεργασίας προσωπικών δεδομένων που επιβάλλεται από το νόμο, δημόσιο συμφέρον), το εν λόγω δικαίωμα υπόκειται σε συγκεκριμένους περιορισμούς ή δεν υφίσταται ανάλογα με την περίπτωση.')}}
                </p>
                <p>
                 <strong>   {{__('protection.Δικαίωμα περιορισμού της επεξεργασίας:')}} </strong> {{__('protection.Έχετε δικαίωμα να ζητήσετε περιορισμό της επεξεργασίας των προσωπικών σας δεδομένων στις ακόλουθες περιπτώσεις: (α) όταν αμφισβητείται την ακρίβεια των προσωπικών δεδομένων και μέχρι να γίνει επαλήθευση, (β) όταν αντιτίθεστε στη διαγραφή προσωπικών δεδομένων και ζητάτε αντί διαγραφής τον περιορισμό χρήσης αυτών, (γ) όταν τα προσωπικά δεδομένα δεν χρειάζονται για τους σκοπούς επεξεργασίας, σας είναι ωστόσο απαραίτητα για τη θεμελίωση, άσκηση, υποστήριξη νομικών αξιώσεων, και (δ) όταν εναντιώνεστε στην επεξεργασία και μέχρι να γίνει επαλήθευση ότι υπάρχουν νόμιμοι λόγοι που μας αφορούν και υπερισχύουν των λόγων για τους οποίους εναντιώνεστε στην επεξεργασία.')}}

                </p>
                <p>
                  <strong>  {{__('protection.Δικαίωμα εναντίωσης στην επεξεργασία:')}} </strong> {{__('protection.Έχετε δικαίωμα να εναντιωθείτε ανά πάσα στιγμή στην επεξεργασία των προσωπικών σας δεδομένων στις περιπτώσεις που, όπως περιγράφεται παραπάνω, αυτή είναι απαραίτητη για σκοπούς εννόμων συμφερόντων που επιδιώκουμε ως υπεύθυνοι επεξεργασίας, καθώς επίσης και στην επεξεργασία για σκοπούς απευθείας εμπορικής προώθησης και κατάρτισης καταναλωτικού προφίλ.')}}

                </p>
                <p>

                   <strong> {{__('protection.Δικαίωμα στη φορητότητα:')}} </strong> {{__('protection.Έχετε δικαίωμα να λάβετε χωρίς χρέωση τα προσωπικά σας δεδομένα σε μορφή που θα σας επιτρέπει να έχετε πρόσβαση σε αυτά, να τα χρησιμοποιήσετε και να τα επεξεργαστείτε με τις κοινώς διαδεδομένες μεθόδους επεξεργασίας. Επίσης, έχετε δικαίωμα να μας ζητήσετε, εφόσον είναι τεχνικά εφικτό, να διαβιβάσουμε τα δεδομένα και απευθείας σε άλλον υπεύθυνο επεξεργασίας. Το δικαίωμα σας αυτό υπάρχει για τα δεδομένα που μας έχετε παράσχει εσείς και η επεξεργασία τους διενεργείται με αυτοματοποιημένα μέσα με βάση της συγκατάθεσή σας ή σε εκτέλεση σχετικής σύμβασης.')}}
                </p>
                <p>
                   <strong> {{__('protection.Δικαίωμα ανάκλησης της συγκατάθεσης:')}}</strong> {{__('protection.Τέλος, η εταιρεία EBLOOM σας ενημερώνει ότι όπου η επεξεργασία βασίζεται στη συγκατάθεσή σας, έχετε δικαίωμα να την ανακαλέσετε ελεύθερα, χωρίς να θιγεί η νομιμότητα της επεξεργασίας που βασίστηκε στη συγκατάθεση σας, προτού την ανακαλέσετε. Για να ανακαλέσετε τη συγκατάθεσή σας μπορείτε να χρησιμοποιήσετε τις επιλογές απεγγραφής, ακολουθώντας την φόρμα επικοινωνίας και πάντα με το ίδιο e-mail που έχετε κάνει δημιουργία λογαριασμού ή να επικοινωνήσετε με την ηλεκτρονική διεύθυνση info@ebloom.gr')}}

                </p>
                <p>
                  {{__('protection.Η παρούσα σύμβαση Προστασίας Προσωπικών Δεδομένων καλύπτει όλα τα προσωπικά δεδομένα των επισκεπτών / χρηστών / μελών που συλλέγει η ιστοσελίδα, κατά τη διάρκεια επίσκεψης και χρήσης των υπηρεσιών της. Επίσης, η παρούσα σύμβαση καλύπτει τις προϋποθέσεις συλλογής, επεξεργασίας και διαχείρισης των προσωπικών δεδομένων των επισκεπτών / χρηστών / μελών από την www.ebloom.gr προς τις τυχόν συνδεδεμένες εταιρείες με αυτό. Η παρούσα σύμβαση δεν καλύπτει σε καμία περίπτωση τη σχέση μεταξύ των επισκεπτών / χρηστών / μελών της www.ebloom.gr και οποιονδήποτε υπηρεσιών που δεν υπόκεινται στον έλεγχο ή/και την ιδιοκτησία της www.ebloom.gr.')}}
                </p>
                <p>
                  {{__('protection.Δεδομένης της φύσης και του όγκου του Διαδικτύου, υπό οποιεσδήποτε συνθήκες, συμπεριλαμβανομένης και της περίπτωσης αμέλειας, η www.ebloom.gr δεν ευθύνεται για οποιασδήποτε μορφής ζημία υποστεί ο επισκέπτης / χρήστης των σελίδων, υπηρεσιών, επιλογών και περιεχομένων της  www.ebloom.gr στις οποίες προβαίνει με δική του πρωτοβουλία και με τη γνώση των όρων του παρόντος.')}}
                </p>
                <p>
                  {{__('protection.Σε κάθε περίπτωση, το σύνολο των δεδομένων σας προστατεύονται και αποτελούν αντικείμενα επεξεργασίας σύμφωνα με τους όρους και τους κανόνες της ελληνικής νομοθεσίας και ιδίως του ν.2472/1997  και του Γενικού κανονισμού για την Προστασία των Προσωπικών Δεδομένων (Κανονισμός 2016/679)], η δε εταιρεία μας ακολουθεί απαρέγκλιτα όλους τους κανόνες που θεσπίζονται από το σχετικό νομοθετικό πλαίσιο. Στο πλαίσιο της ανωτέρω νομοθεσίας, τα στοιχεία που φυλάσσονται από την εταιρεία μας δύνανται να γνωστοποιηθούν σε τρίτους, στις αρμόδιες αρχές, εισαγγελείς ή σε άλλες διοικητικές υπηρεσίες σύμφωνα με τους κανόνες και τις διατάξεις που προβλέπει το εκάστοτε κανονιστικό πλαίσιο.')}}
                </p>
                <p>
                  {{__('protection.Τέλος, προκειμένου για την ολοκλήρωση της διαδικασίας παραγγελίας παρέχετε την ανεπιφύλακτη συγκατάθεσή σας για την αποστολή αυτοματοποιημένων ή προσωποποιημένων ηλεκτρονικών μηνυμάτων στην ηλεκτρονική διεύθυνση ή/και στο κινητό τηλέφωνο που μας έχετε γνωστοποιήσει καθώς και τυχόν τηλεφωνική επικοινωνία στα τηλέφωνα που μας έχετε γνωστοποιήσει από υπάλληλο-ους της εταιρείας μας.')}}
                </p>
                <p>

                  {{__('protection.Χρήση των δεδομένων πελατών για σκοπούς διαφήμισης: Για τη διαρκή βελτίωση και ενίσχυση των υπηρεσιών μας, ενδέχεται να σας στέλνουμε μηνύματα μάρκετινγκ μέσω ηλεκτρονικού ταχυδρομείου που σχετίζονται με την επιχείρησή μας. Μπορείτε να επιλέξετε τα είδη των επικοινωνιών που θέλετε να λαμβάνετε οποιαδήποτε στιγμή, ενημερώνοντας τις προτιμήσεις ηλεκτρονικού ταχυδρομείου. Μπορείτε επίσης, να διαγραφείτε οποιαδήποτε στιγμή. Η αποστολή sms στο αριθμό κινητού τηλεφώνου, που μας έχετε δηλώσει κατά την παραγγελία σας, γίνεται με σκοπό να σας ενημερώσει για την εξέλιξη της παραγγελίας σας. Μπορείτε μέσα από το λογαριασμό που έχετε φτιάξει στην ιστοσελίδα μας να επιλέξετε αν θέλετε να λαμβάνετε ή όχι διαφημιστικό/προωθητικό υλικό μέσω sms ή/και ηλεκτρονικού ταχυδρομείου. - Συναίνεση: Δεν θα χρησιμοποιήσουμε τα δεδομένα σας για διαφημιστικούς σκοπούς, εκτός εάν έχετε δώσει την προηγούμενη ρητή και ελεύθερη συγκατάθεσή σας. - Ωστόσο, για υπάρχοντες πελάτες, ενδέχεται να χρησιμοποιήσουμε την διεύθυνση ηλεκτρονικού ταχυδρομείου που έχουμε λάβει από εσάς στο πλαίσιο της ήδη υπάρχουσας πελατειακής σχέσης μας, για να σας παρέχουμε υλικά μάρκετινγκ που σχετίζονται με παρόμοια προϊόντα ή υπηρεσίες που προηγουμένως έχετε ζητήσει, χρησιμοποιήσει ή ίσως σας ενδιαφέρουν. Μπορείτε, ωστόσο, να αντιταχθείτε στη χρήση αυτή κατά το χρόνο της συλλογής και κάθε φορά που στέλνεται ένα μήνυμα. Προκειμένου να σταματήσετε να λαμβάνετε μηνύματα ηλεκτρονικού ταχυδρομείου για σκοπούς μάρκετινγκ, ακολουθήστε τις οδηγίες μέσα στο μήνυμα ηλεκτρονικού ταχυδρομείου που λαμβάνετε.')}}

                </p>
                <h3>
                  {{__('protection.Πληροφορίες σχετικά με την συλλογή των προσωπικών δεδομένων και τα στοιχεία επαφής του υπευθύνου επεξεργασίας.')}}

                </h3>
                <p>

                  {{__('protection.Παρακάτω θα σας ενημερώσουμε σχετικά με τον τρόπο και τους σκοπούς που διαχειριζόμαστε το προσωπικά σας δεδομένα στον συγκεκριμένο ιστότοπο.')}}
                </p>
                <p>

                  {{__('protection.Ο υπεύθυνος επεξεργασίας διαχείρισης των προσωπικών δεδομένων είναι η εταιρία «EBLOOM GREECE IKE» με το διακριτικό τίτλο «ΕBLOOM»,  που εδρεύει στην Ηλιούπολη Αττικής, στην οδό Σαρωνικού αρ. 33. Email: info@ebloom.gr. Τηλέφωνο: +30 2109703733.')}}
                </p>
                <p>
                  {{__('protection.Ο συγκεκριμένος ιστότοπος χρησιμοποιεί το πρωτόκολλο SSL (Secure Sockets Layer) το οποίο χρησιμοποιεί μεθόδους κρυπτογράφησης των δεδομένων που ανταλλάσσονται μεταξύ δύο συσκευών (συνηθέστερα Ηλεκτρονικών Υπολογιστών), εγκαθιδρύοντας μία ασφαλή σύνδεση μεταξύ τους, μέσω του διαδικτύου, που έχει ως αποτέλεσμα την προστασία των προσωπικών σας δεδομένων, καθώς και άλλων ευαίσθητων δεδομένων (π.χ. εντολές ή έρευνες του υπευθύνου επεξεργασίας). Μπορείτε να αναγνωρίσετε πως βρίσκεστε σε προστατευμένη σύνδεση βλέποντας τους χαρακτήρες https:// και από το σύμβολο κλειδαριάς που εμφανίζεται στην μπάρα διεύθυνσης του περιηγητής σας.')}}
                </p>
                <h3>
                  {{__('protection.Συλλογή δεδομένων όταν επισκέπτεστε τον ιστότοπο.')}}

                </h3>
                <p>
                  {{__('protection.Όταν επισκέπτεστε τον ιστότοπο μονάχα για πληροφορίες, δηλαδή δεν ανοίγετε προσωπικό λογαριασμό για τυχόν παραγγελίες ή δεν δίνετε κανένα από τα προσωπικά σας δεδομένα (π.χ. φόρμα επικοινωνίας), τότε τα μοναδικά δεδομένα που συλλέγουμε είναι εκείνα που ο περιηγητής σας, μεταφέρει στον διακομιστή μας, τα λεγόμενα server log files, και συγκεκριμένα:')}}
                </p>
                <p>
                    •	{{__('protection.Ημερομηνία και ώρα την στιγμή της εισόδου στον ιστότοπο.')}}
                </p> 
                <p>
                    •	{{__('protection.Τον όγκο δεδομένων που στάλθηκαν σε bytes.')}}
                </p>
                <p>
                    •	{{__('protection.Ο περιηγητής που χρησιμοποιήσατε κατά την είσοδό σας στον ιστότοπο.')}}
                </p>
                <p>
                    •	{{__('protection.Το λειτουργικό σύστημα που χρησιμοποιήσατε κατά την είσοδό σας στον ιστότοπο.')}}
                </p>
                <p>
                    •	{{__('protection.Την Διεύθυνση IP (Internet Protocol address) σας, κατά την είσοδό σας στον ιστότοπο.')}}
                </p>

                    
                <p>
                  {{__('protection.Η επεξεργασία των δεδομένων πραγματοποιείται σύμφωνα με το άρθρο 6 παρ. 1 περ. στ’ του Γενικού Κανονισμού Προστασίας Προσωπικών Δεδομένων (GDPR) με βάση το νόμιμο συμφέρον μας για τη βελτίωση της σταθερότητας και της λειτουργικότητας του ιστότοπού μας. Τα δεδομένα δεν θα μεταβιβαστούν ή θα χρησιμοποιηθούν με οποιονδήποτε άλλο τρόπο. Ωστόσο, διατηρούμε το δικαίωμα να ελέγξουμε τα αρχεία καταγραφής διακομιστών (server log files), εάν διαπιστωθούν συγκεκριμένες ενδείξεις παράνομης χρήσης.')}}
                </p>
