          ...
          <div class="static-page-hero-warper position-absolute w-100 bg-white">
            <div class="col-lg-6 px-0 pl-lg-5 pr-lg-0 ml-auto h-100">
              <div class="static-page-hero bg-grey h-100 d-flex align-items-end"
                style="background-image: url('{{asset("frontEnd-assets/images/tablet_ebloom.jpg")}}');background-size: 100% 100%;">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                    ...
                    {{-- <p class="font-weight-normal h3 text-muted">Έμεινες χαρούμενος ή κάτι πήγε λάθος; Μίλησέ μας!</p> --}}
                  </div>
                  <hr class="d-block d-lg-none my-11">
                  <h1>{{__('words.Συμπλήρωσε τα παρακάτω στοιχεία για να επικοινωνήσουμε μαζί σου άμεσα')}}</h1>
                  <br>
                  {{-- <p>Τηλέφωνο eBloom:
                    <strong>
                      <a href="tel:+302109703733"> 210 9703733</a>
                    </strong>
                  </p> --}}
                  <style>
                    #loading {
                  ...
                  <form action="{{url(app()->getLocale().'/pages/shop')}}" method="POST" accept-charset="utf-8" id="contact-form"
                    class="mt-5 has-validation-callback" style="margin-bottom: 20px;">
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="shopNameFormGroup">
                          <div class=" field-required">
                            <label class="d-block" for="firstname"> {{__('words.Όνομα καταστήματος')}} <span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="firstname" value=""
                              id="shop_name" placeholder="{{__('words.Το όνομα του καταστήματος')}}">
                          </div>
                        </div>
                      </div>

                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="shopAddressFormGroup">
                          <div class="field-required" id="customersurnamefield">
                            <label class="d-block" for="lastname"> {{__('words.Διεύθυνση καταστήματος')}}<span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="lastname" value=""
                              id="shop_address" placeholder="{{__('words.Διεύθυνση του καταστήματος')}}">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="shopPhoneFormGroup">
                          <div class=" field-required">
                            <label class="d-block" for="firstname"> {{__('words.Τηλέφωνο καταστήματος')}}<span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="firstname" value=""
                              id="shop_phone" placeholder="{{__('words.Το τηλέφωνο του καταστήματος')}}">
                          </div>
                        </div>
                      </div>

                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="shopOperatorFormGroup">
                          <div class="field-required" id="customersurnamefield">
                            <label class="d-block" for="lastname"> {{__('words.Όνομα υπευθύνου')}} <span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="lastname" value=""
                              id="shop_operator" placeholder="{{__('words.Το όνομα του υπευθύνου')}}">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="operatorPhoneFormGroup">
                          <div class=" field-required">
                            <label class="d-block" for="firstname">{{__('words.Τηλέφωνο υπεύθυνου')}} <span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="firstname" value=""
                              id="operator_phone" placeholder="{{__('words.Το τηλέφωνο του υπευθύνου')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="emailFormGroup">
                          <div class="field-required" id="customersurnamefield">
                            <label class="d-block" for="lastname">email <span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="lastname" value=""
                              id="email" placeholder="{{__('words.Το email σου')}}">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="field-required" id="messageFormGroup">
                        <label class="d-block" for="message"> {{__('words.Μήνυμα')}}</label>
                        <textarea data-validation="required" data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" id="message"
                          name="message" placeholder="{{__('words.Το μήνυμά σου')}}"></textarea>
                      </div>
                    </div>

                    <input type="hidden" name="user_id" value="0" id="user_id">

                    <p class="required-notice"> {{__('words.Τα πεδία με')}}<span class="text-danger">*</span> {{__('words.είναι υποχρεωτικά.')}}</p>
                    <div class="wait" >
                      <div id="loading"></div>

                    </div>
                    <!-- Success Message -->
                    <div class="alert alert-success alert-block success-msg d-none">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                        </button>
                        @if(app()->getLocale() == 'gr' )

                        <strong>Στείλτε τα στοιχεία του καταστήματός σας στο ebloom.gr</strong>

                        @else

                        <strong>Your store information send to ebloom.gr</strong>

                        @endif
                    </div>
                    <!-- Success Message -->
                    <br>
                    <input class="button button-primary w-50" id="shopBtn" type="button" name="submit" value="{{__('words.Αποστολή')}}">

                    <div class="messages alert alert-form mt-5"></div>
                  </form>
                  {{-- end add shop form --}}
                  ...
                  <script type="text/javascript">
                      $(document).ready(function () {
                          ...
                          $("#operator_phone,#shop_phone").keypress(function (e) {
                          ...
                          $("#email").blur(function (e) {
                              ...
                              // }
                              if (IsEmail(val)==false) {
                                          $("#emailFromGroup").addClass( "has-error" );
                                          $("#email").addClass( "error" );
                                          $("#email").css("border-color", `rgb(185, 74, 72)`);
                                      }else{
                                          $("#emailFromGroup").removeClass( "has-error" );
                          ...
                          $('#shop_name,#shop_operator').keydown(function (e) {
                          ...
                          $("#shopBtn").click(function(e) {
                              ...
                              var shopOperetor = $("#shop_operator").val();
                              var operatorPhone = $("#operator_phone").val();

                              var email = $("#email").val();
                              var msg = $("#message").val();
                              console.log('operator name: '+shopOperetor);
                              ...
                              if (shopName === "" || shopAddress === "" || isEmail === false || shopPhone ==="" || shopOperetor ==="" || operatorPhone ==="" ) {
                                $('.wait').css('display','none');
                                  ...
                                  if (shopName ==="") {
                                      // console.log('enter sender No');
                                      $("#shopNameFormGroup").addClass( "has-error" );
                                      $("#shop_name").addClass( "error" );
                                      $("#shop_name").css("border-color", `rgb(185, 74, 72)`);
                                  }else{
                                      $("#shopNameFormGroup").removeClass( "has-error" );
                                      $("#shop_name").removeClass( "error" );

                                  }
                                  if (shopAddress ==="") {

                                      $("#shopAddressFormGroup").addClass( "has-error" );
                                      $("#shop_address").addClass( "error" );
                                      $("#shop_address").css("border-color", `rgb(185, 74, 72)`);
                                  }else{
                                      $("#shopAddressFormGroup").removeClass( "has-error" );
                                      $("#shop_address").removeClass( "error" );
                                  ...
                                  if (shopPhone ==="") {
                                      ...
                                      $("#shopPhoneFormGroup").addClass( "has-error" );
                                      $("#shop_phone").addClass( "error" );
                                      $("#shop_phone").css("border-color", `rgb(185, 74, 72)`);
                                  }else{
                                      $("#shopPhoneFormGroup").removeClass( "has-error" );
                                      $("#shop_phone").removeClass( "error" );
                                  ...
                                  if (shopOperetor ==="") {
                                      ...
                                      $("#shopOperatorFormGroup").addClass( "has-error" );
                                      $("#shop_operator").addClass( "error" );
                                      $("#shop_operator").css("border-color", `rgb(185, 74, 72)`);
                                  }else{
                                      $("#shopOperatorFormGroup").removeClass( "has-error" );
                                      $("#shop_operator").removeClass( "error" );

                                  }

                                  if (operatorPhone ==="") {

                                      $("#operatorPhoneFormGroup").addClass( "has-error" );
                                      $("#operator_phone").addClass( "error" );
                                      $("#operator_phone").css("border-color", `rgb(185, 74, 72)`);
                                  }else{
                                      $("#operatorPhoneFormGroup").removeClass( "has-error" );
                                      $("#operator_phone").removeClass( "error" );
                                ...
                                // alert('check');
                                  ...
                                  $.ajax({
                                      url: "{{ url(app()->getLocale().'/pages/shop') }}",
                                      type: 'POST',
                              data: {
                                  shopName:shopName,
                                  shopPhone: shopPhone,
                                  shopAddress:shopAddress,
                                  shopOperetor:shopOperetor,
                              ...
                              // var orderUrl = `https://demo.vivapayments.com/web/newtransaction.aspx?ref=${orderId}`;
