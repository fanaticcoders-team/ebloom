            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  <h3>{{__('reward.ΣΥΣΤΗΜΑ ΕΠΙΒΡΑΒΕΥΣΗΣ')}}</h3>
                  <p>
                      1. {{__('reward.Το σύστημα επιβράβευσης αποτελεί μία υπηρεσία της πλατφόρμας που παρέχεται μόνον στους εγγεγραμμένους χρήστες, οι οποίοι πραγματοποιούν τις online αγορές τους μέσω της πλατφόρμας.')}}

                  </p>
                  <p>
                      2. {{__('reward.Με κάθε αγορά ο εγγεγραμμένος χρήστης αποκτά ίσο αριθμό πόντων με έκαστο ευρώ που κατέβαλε για την παραγγελία, αφαιρουμένου του κόστους των μεταφορικών. Η πίστωση των πόντων λαμβάνει χώρα αυτόματα στο λογαριασμό του χρήστη με την ολοκλήρωση της ηλεκτρονικής αγοράς και οι οποίοι μπορούν να εξαργυρωθούν στην αμέσως επόμενη παραγγελία. Σημειώνεται ότι ακόμη και για την παραγγελία που εξαργυρώνονται πόντοι, πιστώνονται οι αντίστοιχοι με το ποσό της παραγγελίας.')}} 
                    </p>
                    <p>
                        3. {{__('reward.Οι πόντοι που διαθέτει έκαστος χρήσης γνωστοποιούνται με την αποστολή ενημερωτικού email από την πλατφόρμα και είναι διαθέσιμοι από την αμέσως επόμενη παραγγελία. Περαιτέρω, κατά το στάδιο πριν την ολοκλήρωση της παραγγελίας υπάρχει αντίστοιχη ενημέρωση για το ύψος των διαθέσιμων πόντων προς εξαργύρωση, παρεχόμενης αναλόγως της δυνατότητας να εξαργυρωθούν.')}} 

                    </p>
                    <p>
                        4. {{__('reward.Σημειώνεται ότι η εξαργύρωση των πόντων μπορεί να λάβει χώρα μετά τη συμπλήρωση  των εκατό (100) πρώτων πόντων εκάστου χρήστη. Για κάθε παραγγελία το επιτρεπτό όριο εξαργύρωσης είναι εκατό (100) πόντοι.')}} 
                    </p>
                    <p>
                        5. {{__('reward.Κάθε εκατό (100) πόντοι αντιστοιχούν σε πέντε (5) ευρώ, ήτοι με κάθε εξαργύρωση εκατό πόντων λαμβάνετε έκπτωση ποσού πέντε ευρώ.')}} 
                    </p>
                    <p>

                        6. {{__('reward.Στην περίπτωση που μία παραγγελία ακυρωθεί ή επιστραφεί, δεν λαμβάνει χώρα πίστωση πόντων.')}} 
                    </p>
                    <p>

                        7. {{__('reward.Οι πόντοι είναι προσωπικοί και πιστώνονται στο λογαριασμό κάθε χρήστη. Γι’ αυτό το λόγο δεν μπορούν να μεταβιβασθούν ή πιστωθούν σε έτερο χρήστη.')}} 
                    </p>
                    <p>

                        8. {{__('reward.Με την εγγραφή στην πλατφόρμα και τη δημιουργία λογαριασμού χρήστη λαμβάνετε αυτόματα είκοσι (20) πόντους ως δώρο.')}} 
                    </p>
                    <p>

                        9. {{__('reward.Το παρόν σύστημα δύναται να τροποποιηθεί οποτεδήποτε χωρίς προηγούμενη ενημέρωση του χρήστη.')}} 
                    </p>
