...
<ul class="nav nav-pills flex-nowrap py-7">
  <li class="nav-item">
    <a class="nav-link text-white " href="{{url(app()->getLocale().'/user_account')}}">
  ...
  <li class="nav-item">
    <a class="nav-link text-white active" href="{{url(app()->getLocale().'/user/favorite_store')}}">
...
<section class="position-relative">
    <div class="container">
        <div class="position-relative" style="margin-top: -25px; z-index: 1;">
            <div class="bg-white box-shadow rounded mb-5 mb-md-7">
                <div class="px-7 pt-7 pt-lg-11 px-lg-5 pt-xl-11 px-xl-11 border-bottom">
                    <h2>
                      
                      {{__('words.Αγαπημένα Καταστήματα')}}

                      {{-- Your favourite stores --}}
                    </h2>
                    <p class="text-muted">
                      
                      {{__('words.Μερικά καταστήματα έχουν μια ξεχωριστή θέση στην καρδιά σας. Συλλέξτε τα εδώ για να τα βρείτε εύκολα και γρήγορα.')}}
                      
                      {{-- Some stores have a special place in your heart. Collect them here in order to find them easily and quickly time you need to order. --}}
                    </p>
                </div>
                <ul class="list-unstyled">
                  <div class="shops-listing-shops position-relative mt-5">
                    ...
                    >
                      ...
                      />
                      <h4 class="h2 mx-auto mb-4">
                        
                      {{__('words.Δεν υπάρχουν αποτελέσματα')}}
                      ...
                      {{__('words.Δυστυχώς δεν βρήκαμε καταστήματα που')}}

                        <br />
                        
                      {{__('words.να εξυπηρετούν τη διεύθυνσή σου')}}
                      ...
                      {{__('words.Δε βρέθηκε κατάστημα που να ταιριάζει στην αναζήτησή σου.')}}

                        <br />
                        
                      {{__('words.Προσπάθησε με διαφορετικούς όρους.')}}
                    ...
                    <div class="shops-listings-shops-list">
                      ...
                      >
                        ...
                        <a
                          ...
                          class="shops-listing-shop position-relative floristA"
                        >
                          <div
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                <div class="d-flex text-muted small flex-wrap">
                                  ...
                                  {{__('words.Ελαχ')}}. {{$florist->minimam_order ?? '0' }}
                                </div>
                              </div>
                            </div>
                            <div
                            ...
                            >
                              <div class="text-yellow d-flex align-items-center deleteBtn" data-slug="{{$florist->slug}}">
                                  {{-- <a href="{{url('/delete-wish-list/'.$florist->slug)}}"> --}}
                  ...
                  {{-- start no favorite stores  --}}
                        {{-- <div class="px-7 px-lg-5 text-center py-12">
                            <img class="mb-5" src="{{asset("frontEnd-assets/site-assets/img/icons/basket.png")}}" alt="No orders">
                            
                            <h3 class="h1">There are no stores in your favourites</h3>
                            <p class="col-md-6 mx-auto text-muted mb-11">Add your favourite stores and make your order even quicker and easier</p>
                        </div> --}}
                        {{-- end not favorite stores --}}
                </ul>
            </div>
        </div>
    </div>
