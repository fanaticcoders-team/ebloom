            ...
            <div class="row">
                ...
                <aside class="page-sidebar">
                  <nav class="page-sidebar-nav">
                    <ul class="list-unstyled">
                      ...
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url(app()->getLocale().'/pages/evaluation')}}"> {{__('words.Πολιτική cookies')}}</a>
                      </li>
                      <li class="rounded ">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  <div class="test-part">
                    <h3>{{__('f&q.Πως κάνω παραγγελία από την ebloom;')}}</h3><br>
                    <p>{{__('f&q.Η διαδικασία της παραγγελίας από την ebloom είναι πολύ απλή, εύκολη και γρήγορη!')}} </p> 
                    <p> 1. {{__('f&q.Ξεκινάτε κάνοντας μια αναζήτηση στην πλατφόρμα της ebloom για ανθοπωλεία που βρίσκονται κοντά σας.')}} </p>
                    <p>2. {{__('f&q.Αφού ολοκληρωθεί, επιλέγετε τα προϊόντα που προτιμάτε (λουλούδια, ανθοδέσμες, συνθέσεις, φυτά κλπ.) από το κατάστημα που σας εξυπηρετεί.')}} </p>
                    <p>3. {{__('f&q.Τέλος, καταχωρείτε την παραγγελία σας.')}} </p>
                  </div>

                  <h3>{{__('f&q.Σε πόση ώρα θα φτάσει η παραγγελία μου στο προορισμό της;')}} </h3>
                  <p>
                    {{__('f&q.Για κάθε παραγγελία που κάνετε είναι διαθέσιμη η διαδικασία επιλογής των ωρών της παράδοσης, την οποία θα δείτε στην οθόνη σας. Γενικότερα, ο μέρος όρος του χρόνου παράδοσης των παραγγελιών, στις περισσότερες περιοχές, υπολογίζεται στις δύο ώρες.')}} 
                  </p>
                  
                  <h3> {{__('f&q.Από ποιες τοποθεσίες μπορώ να κάνω παραγγελία;')}} </h3>

                  <p> 
                    {{__('f&q.Μέσω της ebloom μπορείτε να κάνετε παραγγελία από οποιοδήποτε σημείο του πλανήτη, Ελλάδα ή εξωτερικό. Ακόμη κι αν δεν βρίσκεστε στη χώρα λοιπόν, με μερικά απλά βήματα, μπορείτε να στείλετε λουλούδια σε όλη την Ελλάδα εύκολα και γρήγορα!')}} 
                  </p>
                  {{--  --}}
                  <h3> {{__('f&q.Σε ποιες τοποθεσίες μπορώ να στείλω λουλούδια;')}} </h3>
                  <p>
                    {{__('f&q.Η ebloom, μέσω του δικτύου συνεργαζόμενων ανθοπωλείων που διαθέτει, σας δίνει τη δυνατότητα να στέλνετε λουλούδια σχεδόν σε όλη την Ελλάδα. Οι περιοχές στις οποίες είμαστε πιο ενεργοί είναι η Αθήνα, η Θεσσαλονίκη και η Λάρισα, καθώς όμως το δίκτυό μας αυξάνεται καθημερινά, με την πάροδο του χρόνου θα μπορούμε να καλύπτουμε ολοένα και περισσότερες τοποθεσίες.')}} 
                </p>
                  {{--  --}}
                  <h3> {{__('f&q.Τι μπορώ να παραγγείλω από την ebloom;')}} </h3>
                  <p>
                    {{__('f&q.Στην ebloom υπάρχει ένα μεγάλο δίκτυο ανθοπωλείων από πολλές περιοχές της Ελλάδας. Συνεπώς, θα βρείτε μια τεράστια ποικιλία από άνθη, ανθοδέσμες, φυτά, συνθέσεις λουλουδιών, αλλά και γενικότερα ανθοκομικά προϊόντα.  Το μόνο που έχετε να κάνετε είναι να επιλέξετε!')}} 
                  </p>
                  {{--  --}}
                  <h3> {{__('f&q.Είναι απαραίτητο να γνωρίζω τη διεύθυνση του ατόμου στο οποίο θέλω να στείλω λουλούδια;')}} </h3>
                  <p>
                    {{__('f&q.Όχι απαραίτητα! Η ebloom σας δίνει τη δυνατότητα να στείλετε την παραγγελία σας ακόμη κι αν δεν γνωρίζετε την ακριβή διεύθυνση του παραλήπτη. Αφού κάνετε μια αναζήτηση για ανθοπωλεία που βρίσκονται στην περιοχή του παραλήπτη και επιλέξετε την παραγγελία, το μόνο που χρειάζεται είναι να μας δώσετε κάποια στοιχεία, όπως ένα όνομα κι ένα τηλέφωνο. Στη συνέχεια, αναλαμβάνουμε εμείς την επικοινωνία με το άτομο που θα παραλάβει και την αποστολή.')}} 
                  </p>
                  {{--  --}}

                <h3> {{__('f&q.Πως γίνεται η πληρωμή;')}} </h3>
          <p>
            {{__('f&q.Η πληρωμή για τις παραγγελίες μέσω της ebloom πραγματοποιείται με πιστωτική/ χρεωστική κάρτα ή με τη χρήση των υπηρεσιών Viva Wallet.')}} 
          </p>
          <h3> {{__('f&q.Είναι ασφαλής η πληρωμή;')}} </h3>
          <p>
            {{__('f&q.Στόχος μας είναι όλες οι συναλλαγές σας μέσω της ebloom να είναι γρήγορες, εύκολες και, πάνω απ’ όλα, απολύτως ασφαλείς. Εγγυούμαστε προσωπικά για την ασφάλεια των συναλλαγών μας και είμαστε στη διάθεσή σας για οποιεσδήποτε περεταίρω ερωτήσεις ή διευκρινίσεις.')}}
          </p>
          <h3> {{__('f&q.Υπάρχει εφαρμογή για τις υπηρεσίες της ebloom;')}} </h3>
          <p>
            {{__('f&q.Στην ebloom γνωρίζουμε πόσο σημαντικές είναι οι εύκολες και γρήγορες διαδικασίες, καθώς και η διαθεσιμότητα των υπηρεσιών μας μέσω κινητού τηλεφώνου. Συνεπώς, εργαζόμαστε αυτή τη στιγμή και η εφαρμογή της ebloom θα είναι σύντομα κοντά σας.')}} 
          </p>
