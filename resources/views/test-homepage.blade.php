...
<div id="content" class="has-off-canvas-sidebar rigid-left-sidebar">
    ...
    /* background-image:url({{asset('frontEnd-assets/images/hero2.jpg')}}); */
      ...
      " class="FrontHeroBanner-module__image___2eq8H" style="opacity: 1;" alt=""> --}}
            ...
            {{-- <div class="fade-word">
                ...
                style="width: 100%; display: flex">
                    {{-- <div class="col-md-8"> --}}
                    <div class="part-1" style="margin-right: 16px;flex: 1;">
                        ...
                        {{-- <p style="color: black; text-align: center;" class="buttom-text">
                            @if (app()->getLocale() == 'gr' )
                    ...
                    <div class="part-2">
                        ...
                        {{-- <p style="color: black; " class="buttom-tex">
                            @if (app()->getLocale() == 'gr' )
                            Δωρεάν άμεση παράδοση
                            <br>
                            Απο τοπικά ανθοπωλεία
                ...
                <div class="buttom-text" style="width: 90%; display: flex; color: black; text-align: center; justify-content: center">
                    <p>
