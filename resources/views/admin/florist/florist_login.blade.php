...
<body>
	...
	<div class="container-login100" style="background-image: url('{{asset("login/images/bg-01.jpg")}}');">
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			...
			<br>
			<form class="login100-form validate-form" action="{{url(app()->getLocale().'/florist')}}" method="POST"> {{ csrf_field() }}
				...
				@if (app()->getLocale() == 'gr' )
					...
					data-validate="Εισάγετε το κωδικό σας"
				...
				>
					...
					@if (app()->getLocale() == 'gr' )
						...
						placeholder="Εισάγετε το κωδικό σας"
				...
				<div class="text-center">
					<a href="{{url(app()->getLocale().'/florist-forget-password')}}" class="txt2 hov1">
						@if (app()->getLocale() == 'gr' )
