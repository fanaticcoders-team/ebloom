            ...
            <div class="panel panel-bd lobidrag">
               <div class="panel-heading">
                  <div class="btn-group" id="buttonlist"> 
                     ...
                     <i class="fa fa-pancil-o"></i>Edit Time Table </span>  
                  </div>
               </div>
               <div class="panel-body">
               <form class="col-sm-6" enctype="multipart/form-data" action="{{url(app()->getLocale().'/florist/edit-timetable/'.$timeTable->id)}}" method="post"> {{csrf_field()}}
