       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url(app()->getLocale().'/admin/add-attributes/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
            ...
            <div class="panel panel-bd lobidrag">
               ...
               <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                  ...
                  <div class="table-responsive">
                     ...
                     <form enctype="multipart/form-data" action="{{url(app()->getLocale().'/admin/edit-attributes/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                        <thead>
                           <tr class="info">
                              <th>Category ID</th>
                              <th>SKU</th>
                           ...
                           <td><input type="text" name="sku[]" value="{{$attribute->sku}}" style="text-align:center;"> </td>
                              ...
                              <td class="center">
                                 <div class="btn-group">
                                       ...
                                       <a href="{{url(app()->getLocale().'/admin/delete-attribute/'.$attribute->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> </a>
                                 </div>
                              </td>
                           </tr>
                            @endforeach
