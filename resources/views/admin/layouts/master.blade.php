...
<meta name="csrf-token" content="{{csrf_token()}}">
         ...
         $(document).ready(function () {
            ...
            $('.floristLogoutBtn').click(function (e) {
               ...
               if (checkNew === 0 ) {
                  ...
                  window.location.href = "{{url('/florist-logout')}}";
               }else{
            ...
            $('.notification-li').click(function (e) {
               e.preventDefault();
               ...
               $.ajax({
                  ...
                  type : 'post',
                  url : "{{url(app()->getLocale().'/mark-as-read')}}",
                  data : {id:id},
                  success:function(data){
                     console.log(data);
                     window.location.href = `{{url(app()->getLocale().'/admin/florist-dashboard/${slug}')}}`;
                  },error:function(){
  ...
  <script>
         ...
         $(".blogStatus").change(function(){
            ...
            if($(this).prop("checked")==true){
               $.ajax({
                  ...
                  type : 'post',
                  url : "{{url(app()->getLocale().'/admin/update-blog-status')}}",
         ...
         $(".FeaturedStatus").change(function(){
          ...
          if($(this).prop("checked")==true){
             $.ajax({
                ...
                type : 'post',
                url : "{{url(app()->getLocale().'/admin/update-featured-florist-status')}}",
    ...
    var fieldHTML = '<div style="display:flex;"><input type="text" name="heading[]" id="heading" placeholder="Heading" class="form-control" style="width:30%;margin-right:5px;margin-top:5px;"/> <textarea  name="description[]" id="description" placeholder="discription" class="form-control" style="width:60%;margin-right:5px;"></textarea><a href="javascript:void(0);" class="remove_button btn btn-danger" style="height: 35px;"><i class="fa fa-trash-o"></i></a></div>'; //New input field html 
    ...
    $(wrapper).on('keypress','.metersFrom,.metersTo,.price',function (e) {
      ...
      <script>
         $(document).ready(function () {
            ...
            //   $('#table_id_filter').each(function() {
            //       $(this).html( $(this).html().replace( re, `<span>
            //          Αναζήτηση:
            ...
            // // $('#table_id_filter:contains("Search:")').html().replace('Search:', 'Αναζήτηση:');
