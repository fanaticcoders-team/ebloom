...
<header class="main-header">
        <a href="{{url(app()->getLocale().'/admin/dashboard')}}" class="logo">
           <!-- Logo -->
         ...
         <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                 ...
                 <li class="dropdown notifications-menu">
                    ...
                    @if (Session::get('adminSession') == 'admin')
                    <span class="label label-warning">{{count(Session::get('notifications'))}}</span>
                    @else
                       ...
                       <li>
                          <ul class="menu">
                             @if (Session::get('adminSession') == 'admin')
                              ...
                              <li class="notification-li" data-id="{{$notification->id}}" data-slug = "{{$notification->data['slug']}}">
                                 <a href="#" class="border-gray"> 
                                 <i class="fa fa-shopping-bag color-green"></i>{{$notification->data['data'] }}</a>
                              </li>
                              {{-- <li class="list-group-item ">
                                 <div class="md-v-line"></div><i class="fa fa-trash-o mr-4 pr-3"></i>
                             ...
                             <li>
                                <a href="{{url(app()->getLocale().'/admin/orders')}}" class="border-gray">
                 ...
                 <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu" >
                        @if (Session::get('adminSession')=='admin')
                           ...
                           <li>
                              <a href="{{url(app()->getLocale().'/admin/admin-profile')}}">
                              <i class="fa fa-user"></i> User Profile</a>
                           </li> 
                           <li><a href="{{url(app()->getLocale().'/admin-logout')}}">
                        ...
                        @else
                           ...
                           <li>
                              ...
                              <i class="fa fa-user"></i> Florist Store</a>
                           </li> 
                           {{-- {{url('/florist-logout')}} --}}
                           <li class="floristLogoutBtn"><a href="#"  class="floristLogoutBtn">
                              <i class="fa fa-sign-out"></i> Sign out</a>
                           </li>
                        @endif
                    </ul>
