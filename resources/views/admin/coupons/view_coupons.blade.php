             ...
             <div class="panel panel-bd lobidrag">
                ...
                <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                   <div class="btn-group">
                      ...
                      <a class="btn btn-add" href="{{url(app()->getLocale().'/admin/add-coupon')}}"> <i class="fa fa-plus"></i> 
                   ...
                   <div class="table-responsive">
                      <table id="table_id" class="table table-bordered table-striped table-hover">
                         ...
                         <tbody>
                            ...
                            <td>
                            <a href="{{url(app()->getLocale().'/admin/edit-coupon/'.$coupon->id)}}" class="btn btn-add btn-sm" title="{{__('florist.Επεξεργασία')}} "><i class="fa fa-pencil"></i></a>
