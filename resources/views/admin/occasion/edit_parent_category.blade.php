             ...
             <div class="panel panel-bd lobidrag">
                <div class="panel-heading">
                   <div class="btn-group" id="buttonlist"> 
                      <a class="btn btn-add " href="{{url(app()->getLocale().'/admin/add-category')}}"> 
                      <i class="fa fa-eye"></i>  Add Category </a>  
                   </div>
                </div>
                <div class="panel-body">
                <form class="col-sm-6" action="{{url(app()->getLocale().'/admin/edit-parent-category/'.$categoryDetails->id)}}" method="post"> {{csrf_field()}}
