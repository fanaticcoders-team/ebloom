          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body">
                  <form class="col-sm-12" action="{{url(app()->getLocale().'/admin/add-occasion')}}" method="post"> {{csrf_field()}}
                     <div class="row">
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" placeholder="Enter Category Name" name="occasion_name_english" id="category_name" required>
                        </div>
                     </div> 
                     <div class="row" style="display: none">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <textarea name="occasion_description_english" id="occasion_description_english" class="form-control">
