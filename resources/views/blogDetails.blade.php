...
<body data-spy="scroll" data-target="#shop-profile-menu-list-nav" data-offset="122"
  ...
  <div id="main-container">
    ...
    <main>
          ...
          <div class="static-page-hero-warper position-absolute w-100 bg-white">
            <div class="col-lg-6 px-0 pl-lg-5 pr-lg-0 ml-auto h-100">
              <div class="static-page-hero bg-grey h-100 d-flex align-items-end"
                style="background-image: url('/uploads/products/{{$blog->image}}');background-size: 100% 100%;">
              </div>
            </div>
          </div>
        ...
        <section class="static-page-content-wrappe" style="background-color: #f7f7f7;">
          <div class="container">
            <div class="row">
                    ...
                    <div class="cc-modal-inner" >
                      ...
                      {{-- <div class="cc-modal-banner-restaurant">
                        <div class="cc-modal-banner-restaurant__placeholder">
                          ...
                          <div class="cc-modal-banner-restaurant__image" id="product_image2" style=" width: 100%;;height: 370px;
                      ...
                      <div class="cc-modal-header cc-modal-header-restaurant" style="text-align: center; background: #f7f7f7;">
