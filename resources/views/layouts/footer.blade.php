...
<footer class="position-relative">
    ...
    >
      <div class="container">
        ...
        <div class="row ">
          <div class="col-lg-4 mr-auto text-center text-md-left">
            ...
            <div class="social-icons" >
              <div class="SocialsColumn-module__column___3guXg SocialsColumn-module__socialsColumn___2Wzua">
                  <ol class="SocialsColumn-module__socialRow___1cGwT social-icons-ol" style=""> 
                      ...
                      <li class="SocialsColumn-module__socialListItem___3irFk" style="margin-left: 3px !important; "><a data-test-id="social-button-instagram"
          ...
          {{-- footer categories --}}
          <div class="col-lg-5 mb-9 d-md-block" style="position: relative; top: 31px;">
            <ul class="list-unstyled mb-0 footer-links-list" style="column-count: 2;">
              <li>
                <a
        ...
        <div class="d-none d-md-block text-center py-5" style="padding-bottom: 2rem !important; padding-right: 15px;">
            <span class="small mb-0 " style="font-size: 14px; position: relative;
            top: 10px;">
            ...
            {{-- <img src="{{asset('frontEnd-assets/images/cards-01.png')}}" alt="" style="float: right"> --}}

        </div>


    <div class="back-to-top d-md-none bg-white ">
      <a
        href="#"
      ...
      <img src="{{asset('frontEnd-assets/images/cards-03.png')}}" alt="" class="cards-image" style="margin-left: 3%;">
...
<div id="cookieAcceptBar" class="cookieAcceptBar">
  Για να κάνουμε αυτόν τον ιστότοπο να λειτουργεί σωστά και για να προσφέρει μια καλύτερη εμπειρία χρήστη, χρησιμοποιούμε τα cookies.
  ...
  <a href="#">
    Μάθετε περισσότεραx
    {{-- cookies policy --}}
  </a><br> <button id="cookieAcceptBarConfirm" class="btn btn-success">
    ΑΠΟΔΟΧΗ
    {{-- Αποδοχή --}}
