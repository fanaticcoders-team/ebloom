...
<script>
  ...
  <div id="main-container">
    ...
    <main>
        ...
        <section class="static-page-content-wrapper" style="padding-bottom:80px">
          <div class="container">
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                ...
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  <div class="d-block d-lg-none d-flex flex-column justify-content-center text-center">
                    <h1 class="display-1 font-weight-bold"> {{__('words.Επικοινωνία')}} </h1>
                  ...
                  <h3>{{__('words.Επικοινωνία')}}</h3>

                  <p>{{__('words.Τηλέφωνο eBloom')}}:
                    <strong>
                  ...
                  <form action="/pages/contact" method="POST" accept-charset="utf-8" id="contact-form"
                    class="mt-5 has-validation-callback">
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="firstnameFormGroup">
                          <div class=" field-required">
                            <label class="d-block" for="firstname"> {{__('words.Όνομα')}}  <span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              ...
                              id="firstname" placeholder="{{__('words.Το όνομά σου')}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group" id="lastnameFormGroup">
                          <div class="field-required" id="customersurnamefield">
                            <label class="d-block" for="lastname"> {{__('words.Επίθετο')}}<span class="text-danger">*</span></label>
                            <input class="w-100 rounded border px-5 py-4" data-validation="required"
                              data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="text" name="lastname" value=""
                              id="lastname" placeholder="{{__('words.Το επίθετό σου')}}">
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="form-group field-required" id="emailFromGroup">
                      <label class="d-block" for="email">E-mail <span class="text-danger">*</span></label>
                      <input class="w-100 rounded border px-5 py-4" data-validation="email"
                        data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" type="email" name="email" value="" id="email"
                        placeholder="{{__('words.Το email σου')}}">
                    </div>

                    <div class="form-group">
                      <label class="d-block" for="cellphone"> {{__('words.Τηλέφωνο')}}</label>
                      <input class="w-100 rounded border px-5 py-4" type="text" name="cellphone" value="" id="cellphone"
                        placeholder="{{__('words.Το κινητό σου')}}">
                    </div>

                    <div class="form-group">
                      <div class="field-required" id="messageFormGroup">
                        <label class="d-block" for="message"> {{__('words.Μήνυμα')}}<span class="text-danger">*</span></label>
                    ...
                    <br />
                    <!-- Alert Message for the contact form -->
                    <div class="alert alert-success alert-block success-msg d-none">
                      ...
                      <strong>Σας ευχαριστούμε. Θα επικοινωνήσουμε άμεσα μαζί σας.</strong>

                      @else

                      <strong>Thank you. We will contact you immediately.</strong>

                      @endif
                    </div>
                    <!-- // Alert Message for the contact form -->
                    
                    <input class="button button-primary w-50" id="contactBtn" type="button" name="submit" value="{{__('words.Αποστολή')}}">
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $("#contactBtn").click(function(e) {
                            ...
                            if (firstname === "" || lastname === "" || isEmail === false || lastname ==="" || msg ==="" ) {
                              $('.wait').css('display','none');
                                ...
                                if (firstname ==="") {
                                    ...
                                    $("#firstname").css("border-color", `rgb(185, 74, 72)`);
                                }else{
                                ...
                                if (lastname ==="") {
                                    ...
                                    $("#lastname").css("border-color", `rgb(185, 74, 72)`);
                                }else{
                                ...
                                if (msg ==="") {
                                    $("#messageFormGroup").addClass( "has-error" );
                                    $("#message").addClass( "error" );
                                    $("#message").css("border-color", `rgb(185, 74, 72)`);
                                }else{
                                    $("#messageFormGroup").removeClass( "has-error" );
                                ...
                                $.ajax({
                                    url: "{{ url(app()->getLocale().'/pages/contact') }}",
                                    type: 'POST',
                            data: {
                                firstname:firstname,
                                lastname: lastname,
                                ...
                                message:msg,
                                    ...
                                    success: function(data) {
                                      ...
                                      $('#contact-form')[0].reset();
                                        ...
                                        // alert(data.success);
                                        // window.location.href = "{{ url(app()->getLocale().'/welcome')}}";
