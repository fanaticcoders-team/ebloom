                  ...
                  <h3 style="text-align:center;">
                      ...
                      <p>
                        ...
                        <p>
                            ...
                            <p>
                              {{__('cookies.Λάβετε υπόψη ότι η λειτουργία της ιστοσελίδας μας ενδέχεται να είναι περιορισμένη εάν τα cookies δεν γίνονται δεκτά.')}}
