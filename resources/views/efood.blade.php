...
<meta
  ...
  <head>
    ...
    <link
      ...
      sizes="180x180"
      href="{{asset("frontEnd-assets/images/logo5.png")}}"
    />
    <link
      rel="icon"
      type="image/png"
    ...
    />
    <meta property="og:url" content="https://www.eBloom.gr%2F" />
    ...
    <meta
      property="og:image"
      content="{{asset("frontEnd-assets/site-assets/img/logos/logo50x25.jpg")}}"
    />
    ...
    <script
      async
      src="{{asset("frontEnd-assets/assets/js/9411b219fc.js")}}"
      type="f7cd9a4680c6ccdb45251385-text/javascript"
    ></script>
  ...
  <body
    ...
    data-offset="122"
    class="page brand-eBloom page-homepage time-morning date-19-03 logged-out page-with-cover"
  >
    <script type="f7cd9a4680c6ccdb45251385-text/javascript">
      	dataLayer = [{
          "siteVersion": "2.9.29",
          "isLoggedIn": 0,
          "pageUrl": "https://www.eBloom.gr/",
          "userAddress": "",
          "userAddressLat": 0,
          "userAddressLon": 0,
          "userAddressZip": "",
        ...
        <div class="container d-flex justify-content-around pt-11">
          <div class="how-it-works-step-wrapper">
            <img
              ...
              class="lazyload"
              data-src="frontEnd-assets/site-assets/img/howitworks/facelift/eBloom/step-1.png?v=20201020"
              data-
              srcset="
                /cdn-cgi/image/w=186,h=186,fit=cover,q=100,f=auto/site-assets/img/howitworks/facelift/eBloom/step-1.png?v=20201020 186w
              "
            />
          ...
          <div class="how-it-works-step-wrapper">
            <img
              ...
              class="lazyload"
              data-src="frontEnd-assets/site-assets/img/howitworks/facelift/eBloom/step-2.png?v=20201020"
              data-
              srcset="
                /cdn-cgi/image/w=186,h=186,fit=cover,q=100,f=auto/site-assets/img/howitworks/facelift/eBloom/step-2.png?v=20201020 186w
              "
            />
          ...
          <div class="how-it-works-step-wrapper">
            <img
              ...
              class="lazyload"
              data-src="frontEnd-assets/site-assets/img/howitworks/facelift/eBloom/step-3.png?v=20201020"
              data-
              srcset="
                /cdn-cgi/image/w=186,h=186,fit=cover,q=100,f=auto/site-assets/img/howitworks/facelift/eBloom/step-3.png?v=20201020 186w
              "
            />
          ...
          <div class="row align-items-center justify-content-between h-100">
            <div class="col-lg-auto">
              <a
                ...
                title="Flower Delivery &ndash; Order Online eBloom"
                >eBloom
                
                <img src="{{asset('frontEnd-assets/images/logo5.png')}}" alt="eBloom logo">
                ...
                <div class="dropdown-menu mt-5 py-0 box-shadow" aria-labelledby="dropdownMenuLink">
                    <div>
                        ...
                        <ul class="site-header-user-options-list list-unstyled mb-0">
                            ...
                            {{-- <li class="user-options-list-item">
                                <a href="/account/payment" title="Online payments" class="hover-no-decoration text-muted d-block px-5 py-3">
                                    Online payments                        </a>
                            </li> --}}
        
                            {{-- <li class="user-options-list-item">
                                <a href="/account/addresses" title="My addresses" class="hover-no-decoration text-muted d-block px-5 py-3">
                                    My addresses                        </a>
                            </li> --}}
                            ...
                            {{-- <li class="user-options-list-item">
                                <a href="/account/reviews" title="My reviews" class="hover-no-decoration text-muted d-block px-5 py-3">
                                    My reviews                        </a>
                            </li> --}}
        
                            <li class="user-options-list-item site-header-user-options-list-item-logout border-top">
                                <a class="hover-no-decoration text-muted d-block px-5 py-3 eBloom-data-layer logout-btn" href="{{url('/user_logout')}}">
                                    Log out                        </a>
                            </li>
                        </ul>
                    </div>
      ...
      <main>
        ...
        <div style="background: #f7f7f7">
                          ...
                          <div class="box-shadow rounded position-relative">
                            ...
                            >
                              ...
                              <input type="hidden" name="hidden_region" id="hidden_region">
                                <a href="#popup1"
                                  class="btn btn-primary btn-block btn-lg orderBtn"
                                  >
                                  Order now
                                </a>
                              </div>
          ...
          {{-- end saved input data script 
            ReceiptOptions, bussinessName,vat,bussinessType,bussinessAddress
            --}}
                                  <script>
                                    var dt = new Date();
...
{{-- start homepage address --}}
 ...
 $(document).ready(function () {
  ...
  //   var str = $("#location-input").val();
  //   var prefix = 'Ηλιούπολη, ';
  //   if(str.indexOf(prefix) == 0) {
  //     console.log($("#location-input").val());
  //   } else {
  //     if (prefix.indexOf(str) >= 0) {
  //       // input.value = prefix;
  //       $("#location-input").val(prefix);
  //     } else {
  //       $("#location-input").val(prefix+str);
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function () {
    ...
    console.log("city: "+$("#hiddenCityInGr").val());
   console.log('formated address: '+ formated_address);
    ...
    //google places api code
                              ...
                              function orderBtnFunction() {
                                ...
                                //get the saved value function - return the value of "v" from localStorage. 
                                // console.log('btn click city:'+ $("#cityInGr").val() );
                          ...
                          <a href="#popup1"
                            class="btn btn-primary btn-block btn-lg d-lg-none orderBtn"
                          >
                            Order now
                          </a>
                        {{-- </div> --}}
                        ...
                        <div class="social-login mt-8 row d-lg-none">
                            ...
                            <div class="facebook-login-wrapper">
                              ...
                              >
                                <img
                                  ...
                                  src="frontEnd-assets/site-assets/img/icons/Facebook.png"
                                  width="20"
                                  height="20"
                                  alt="Facebook login"
                                  style="left: 12px"
                          ...
                          {{-- <div class="col-6 pl-2">
                            <div class="google-login-wrapper">
                              ...
                              >
                                <img
                                  class="button-google-login-icon"
                                  src="frontEnd-assets/site-assets/img/icons/Google.png"
                                  width="20"
                                  height="20"
                                  alt="Google login"
                                  style="left: 12px"
                          ...
                          <div class="col-12 mt-4">
                            ...
                            >
                              <img
                                class="button-google-login-icon"
                                src="frontEnd-assets/site-assets/img/icons/Email.png"
                                width="20"
                                height="20"
                                alt="Email login"
                                style="left: 12px"
          ...
          {{-- <div class="coca-cola-icons d-lg-none py-9 text-center">
            <img
              ...
              height="81"
              class="lazyload"
              data-src="frontEnd-assets/site-assets/img/coca/coca-cola-logo-positive@3x.png"
              data-
              srcset="
              ...
              <div class="row">
                ...
                >
                  <div class="mb-5">
                    ...
                    >
                      <img
                        alt="προσφορά The Big Bad Wolf - eBloom"
                        width="87"
                        height="81"
                        class="rounded lazyload"
                        data-src="frontEnd-assets/site-assets/img/welcome/offers/thebigbadwolf.jpg"
                        data-
                        srcset="
                  ...
                  <div class="mb-5">
                    <a href="{{url('/store/'.$florist->slug)}}">
                      <picture class="text-center">
                        ...
                        {{-- <source
                          type="image/webp"
                          data-srcset="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_Aroma-caffe.jpg"
                        />
                        <source
                          type="image/jpeg"
                          data-srcset="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_Aroma-caffe.jpg"
                        ...
                        {{-- <img
                          class="rounded lazyload"
                          loading="lazy"
                          data-src="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_Aroma-caffe.jpg"
                          alt="Aroma caffe"
                  ...
                  <div class="mb-5">
                    <a href="delivery/menu/bullseye.html">
                      <picture class="text-center">
                        ...
                        <source
                          type="image/webp"
                          data-srcset="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_-Bullseye.jpg"
                        />
                        <source
                          type="image/jpeg"
                          data-srcset="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_-Bullseye.jpg"
                        ...
                        <img
                          class="rounded lazyload"
                          loading="lazy"
                          data-src="https://static.eBloom.gr/cdn-cgi/image/w=268,h=168,fit=cover,q=100,f=auto/big-chains/BigChains_-Bullseye.jpg"
                          alt="Bullseye"
                          src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAMAAAACCAQAAAA3fa6RAAAADklEQVR42mNkAANGCAUAACMAA2w/AMgAAAAASUVORK5CYII="
                        />
                      </picture>
            ...
            <div class="container py-lg-11">
              ...
              <div class="homepage-new-shops-slider d-none d-md-block">
                ...
                {{-- <ul class="list-unstyled">
                  ...
                  <li class="mb-3">
                    <a href="delivery/eksarcheia/eBloom-market.html">
                      eBloom market
                    </a>
                  </li>
                </ul> --}}
    ...
    <div id="footer-scripts">
      <script
        data-cfasync="false"
        src="{{asset("frontEnd-assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js")}}"
      ></script>
      <script
    ...
    {{-- <script src="{{asset("frontEnd-assets/assets/js/autocompleteField.js")}}"></script> --}}
  ...
  <!-- Mirrored from www.eBloom.gr/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Mar 2021 08:06:23 GMT -->
</html>
