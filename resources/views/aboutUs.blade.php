            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  <p>
                      {{__('about.Θέλετε να στέλνετε λουλούδια εύκολα, γρήγορα και χωρίς περιορισμούς αποστάσεων; Η eBloom είναι εδώ γι’ αυτόν ακριβώς το λόγο! Πρόκειται για μια νέα ιδέα σχετικά με τον τρόπο που στέλνετε και λαμβάνετε άνθη. Παρατηρώντας μια έλλειψη στις επιλογές αποστολής λουλουδιών στην Ελλάδα δημιουργήσαμε την eBloom, μέσω της οποίας η διαδικασία γίνεται απλά με μερικά click!')}} 
                  
                  </p>
                    <p>
                    {{__('about.Πιστεύουμε πως για κάθε συναίσθημα υπάρχει κι ένα άνθος… Μια τόσο όμορφη κίνηση όσο η προσφορά λουλουδιών μπορεί να αλλάξει άμεσα τη διάθεση του παραλήπτη, να μηδενίσει τις αποστάσεις και να χαρίσει απλόχερα χαμόγελα!Είτε πρόκειται για την ημέρα του Αγίου Βαλεντίνου, μια γιορτή, επέτειο, είτε απλά για να δείξετε στους αγαπημένους σας ανθρώπους πόσο πολύ τους σκέφτεστε, στην eBloom θα βρείτε την κατάλληλη επιλογή για κάθε περίσταση! Υπάρχει ένα τεράστιο δίκτυο συνεργαζόμενων ανθοπωλείων από όπου μπορείτε να παραγγείλετε και να στείλετε λουλούδια κάθε είδους, συνθέσεις ή φυτά μέσα σε δύο ώρες, από όπου κι αν βρίσκεστε, ακόμη και από το εξωτερικό.')}} 
                    </p>
                    <p>
                      {{__('about.Η διαδικασία είναι γρήγορη, εύκολη και – το σημαντικότερο – ασφαλής. Το μόνο που έχετε να κάνετε είναι να γράψετε τη διεύθυνση στην οποία θέλετε να γίνει η παράδοση, να κάνετε την επιλογή σας από τα κοντινά συνεργαζόμενα ανθοπωλεία και να ολοκληρώσετε την πληρωμή με ασφάλεια εντός της πλατφόρμας eBloom.')}} 
                    </p>
                    <p>
                      {{__('about.Στόχος μας είναι να αναβιώσουμε τον ρομαντισμό που πολλές φορές χάνεται στο παρασκήνιο λόγω της καθημερινότητας και των πολλών υποχρεώσεων... Απλοποιώντας λοιπόν την διαδικασία αποστολής λουλουδιών, όσο πιεσμένο κι αν είναι το πρόγραμμά σας, μπορείτε να κάνετε αυτή την όμορφη χειρονομία πανεύκολα και πολύ γρήγορα!')}}                  
                    </p>
                </section>
              </div>
            </div>
