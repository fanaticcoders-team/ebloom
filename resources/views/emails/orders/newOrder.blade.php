...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 18px; font-weight: 500; line-height: 130%;
            ...
            <img src="https://ebloom.gr/frontEnd-assets/images/logo4.png" alt="eBloom logo" style="width: 240px;
            height: 125px;">
		...
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
            ...
            <span style="font-size: 14px;">
              @if (app()->getLocale() == 'en' )
                ...
                We have received an order from {{$order->senderName}}. <br>
              The order is as follows: #{{$order->orderNo}} ({{ $order->created_at->format('d/m/Y') }})
              @else
                Λάβαμε μια παραγγελία από {{$order->senderName}}. <br>
                Για ανθοπωλείο: {{$order->florist_name}} 
                
                {{-- Η παραγγελία έχει ως εξής: #{{$order->orderNo}} ({{ $order->created_at->format('d/m/Y') }}) --}}
    ...
    <tr style="width: 100%">
		    <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding-left: 25%;
            padding-top: 20px; text-align: center" class="hero">
            {{-- <hr> --}}
            @if (app()->getLocale() == 'en' )
                      ...
                      <tr>
                        ...
                        <td width="80px">
                          @foreach ($products as $item)
                             ...
                             height="60px" width="60px" alt="logo" border="0" />
                             @break
                             @endif
                          @endforeach
                        </td>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td
                              ...
                              @if ($order->doorbell != null || $order->doorbell != '')
                              <br>
                                @if (app()->getLocale() == 'en' )
                                
                                Name on bell: {{$order->doorbell}}
                                @else
                                
                                Όνομα στο κουδούνι:  {{$order->doorbell}}
                                @endif
                              ...
                              @if (app()->getLocale() == 'en' )
                                ...
                                @else
                                Κάρτα: λεπτομέρειες στο διαχειριστικό
                                @endif
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td
                            style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                            @if ($order->senderName != null || $order->senderName !='')
                            @if (app()->getLocale() == 'en' )
                            name:  {{$order->senderName}}
                              
                            @else
                            Όνομα: {{$order->senderName}}
                            ...
                            @endif
                            @if ($order->optional_phone != null || $order->optional_phone != '')
                              @if (app()->getLocale() == 'en' )
                              Phone: {{$order->optional_phone}}
                              <br>
                              
                              @else
                              Τηλέφωνο: {{$order->optional_phone}}
                                <br>
                              
                              @endif   
                            @endif
                            
                            @if ($order->senderEmail != null || $order->senderEmail != '')
                              @if (app()->getLocale() == 'en' )
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      Παρακαλούμε όπως ελέγξετε το διαχειριστικό σας για τυχόν λεπτομέρειες και σχόλια του πελάτη.
                      <br>
