                          ...
                          <tr style="margin: 30px 0px; margin-bottom: 10px;">
                            <td >   
                                <span style="font-size: 14px;">
                                   ...
                                   The order #{{$order->orderNo}} ({{ $order->created_at->format('d/m/Y') }}) for {{$order->senderName}} has been cancelled.
                                 </span>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td
                                ...
                                class="article">
                                <img src="https://ebloom.gr/uploads/products/98335.jpeg"
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td
                                        ...
                                        Floor: {{$order->floor}}<br>{{$order->city}}<br> {{$order->mobile}}<br> {{$order->senderEmail}}
                                        <br>
                                      </td>
                                    </tr>
                                  </tbody>
