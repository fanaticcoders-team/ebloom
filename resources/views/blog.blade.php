...
<body data-spy="scroll" data-target="#shop-profile-menu-list-nav" data-offset="122"
  ...
  <script type="7f68c7e5cf399bdea990487a-text/javascript">
    ...
    "siteVersion": "2.9.29",
    "isLoggedIn": 0,
    "pageUrl": "https://www.eBloom.gr/pages/blog",
    "userAddress": "",
    "userAddressLat": "0",
    "userAddressLon": "0",
    "userAddressZip": "",
          ...
          <div class="static-page-hero-warper position-absolute w-100 bg-white">
            <div class="col-lg-6 px-0 pl-lg-5 pr-lg-0 ml-auto h-100">
              <div class="static-page-hero bg-grey h-100 d-flex align-items-end"
                style="background-image: url('{{asset("frontEnd-assets/images/back4.jpeg")}}');
          ...
          <div class="container">
            <div class="row">
                ...
                {{-- <aside class="page-sidebar">
                  <nav class="page-sidebar-nav">
                    <ul class="list-unstyled">
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/about')}}">Ποιοι είμαστε </a>
                      </li>
                      <li class="rounded bg-white font-weight-bold box-shadow">
                        <a class="px-8 py-5 d-block" href="{{url('pages/blog')}}">Βlog </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/contact')}}">Επικοινωνία </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/shop')}}">Έχεις ανθοπωλείο; </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/faqs')}}">Συχνες Ερωτησεις </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="https://globaltouch.international/el/home/">Meet Our Developers </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="/page/privacy">Τρόποι πληρωμής </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/terms')}}">Όροι χρήσης </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/policy')}}">Πολιτική προστασίας </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="/page/payments_faq">Πολιτική cookies </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="/page/reviews">Πολιτική αξιολόγησης </a>
                      </li>
                      <li class="rounded ">
                        <a class="px-8 py-5 d-block" href="{{url('pages/reward')}}">Σύστημα επιβράβευσης </a>
                      </li>
                    </ul>
                  </nav>
                </aside> --}}
              ...
              <div class="col-12 col-lg-6">
                <section style="max-width: 650px;" class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  @if (count($blogs) > 0 )
                    ...
                    @foreach ($blogs as $blog)
                      @if ($blog->status == '1')
                      @if (app()->getLocale() == 'en' )
                        @if ( preg_match('/^[a-z0-9 .}, !@#$%^&*()_+|\';?><-]+$/i',  $blog->title) )
                          <a href="{{url(app()->getLocale().'/blog/'.$blog->slug)}}" style="text-decoration: none">
                            <div class="cc-modal" style="background-color:#fff">
                              <div class="cc-modal-inner" >
                                ...
                                <div class="cc-modal-banner-restaurant">
                                  <div class="cc-modal-banner-restaurant__placeholder">
                                    ...
                                    background-size: 100% 100%; background-image:url('/uploads/products/{{$blog->image}}')">
                                      
                                    </div>
                                  </div>
                                </div>
                                <input type="hidden" name="product_image" id="product_image_input">
                                <div class="cc-modal-header cc-modal-header-restaurant" style="text-align: center;">
                                  <h1 class="cc-modal-header__name" style="font-weight: 700;
                                  font-size: 36px;
                                  padding-right: 8px;" id="product_name"> 
                                  {{$blog->title}}
                                  {{-- Red Flower --}}
                                  </h1>
                                  ...
                                  <div style="margin-top: 15px; line-height: 2; font-size: 1rem;" class="cc-modal-header__description" id="product_description">
              ...
              <div class="col-12 col-lg-3">
                <div style="position: relative;" class="shop-profile-cart shop-profile-cart--no-address shop-profile-cart--minimised">
                  <div id="component-car" class="notranslate" style="margin-top: 0px; min-height: 345px;">
                    <div class="cart cart--no-address">
                        ...
                        <div class="border-top cart-footer">
                            <a href="{{url(app()->getLocale().'/welcome')}}" class="btn btn-block btn-primary btn-lg" >
                              {{__('words.Παραγγελία')}}
                              {{-- Order in 1' --}}
                            </a>
                        </div>
                ...
                {{-- end search --}}
                <div style="position: relative;" class="shop-profile-cart shop-profile-cart--no-address shop-profile-cart--minimised">
                  <div id="component-car" class="notranslate" style="margin-top: 0px; min-height: 300px;">
                    <div class="cart cart--no-address subscribe-body">
                      <form action="{{url(app()->getLocale().'/user/subscribe')}}" method="POST">
                        {{ csrf_field() }}
                        <div class="pt-7 px-3 text-center cart-header d-none d-lg-block">
                            {{-- <h3 class="mb-4 cart--no-address-header-copy text-center font-weight-bold">
                        ...
                        <div class="px-7 mt-7 mb-0  d-none d-lg-block subscribe-input">
                            <div class="">
                              <div class="form-group">
                                <div class="field-required">
                                  <input type="email" name="email" id="login_email" class="form-control" required data-validation="email"
                                    data-validation-error-msg="Enter your email" placeholder="{{__('words.Πληκτρολόγησε το email σου')}}" autocomplete="email">
                                </div>
                              </div>
                            </div>
                        </div>
                        <div class="border-top cart-footer subscribe-btn" >
                          <input type="submit" class="btn btn-block btn-primary btn-lg" value="{{__('words.Εγγραφή')}}">  
                ...
                <div style="position: relative;" class="shop-profile-cart shop-profile-cart--no-address shop-profile-cart--minimised">
                  <h4 class=" btn-block btn-primary btn-lg"  style="border-radius: 0px; background-color: #666666;border-color: #666666;color: white;text-align: center;">
                     {{__('words.Πρόσφατα Post')}}
                    {{-- Order in 1' --}}
                  </h4>
                  <div id="component-car" class="notranslate" style="margin-top: 0px;">
                    <div class="cart cart--no-address">
                      {{-- <div class="container"> --}}
                        @foreach ($latestBlogs as $item)
                          @if ($item->status == '1')
                            @if (app()->getLocale() == 'en' )
                              @if ( preg_match('/^[a-z0-9 .}, !@#$%^&*()_+|\';?><-]+$/i',  $item->title) )
                              

                                <div class="row" style="margin-top: 10px; height: 68px;">
                                  <div class="col-md-4" style="padding-right: 0px; padding-left: 24px; height: 100%;">
                                    {{-- <div class="pl-5 flex-shrink-0"> --}}
                                      <img src="/uploads/products/{{$item->image}}" class=" bg-white rounded " alt="Popular item image" style="width: 100%;height:100%" >
                                    {{-- </div> --}}
                                  </div>
                                  <div class="col-md-8" style="padding-left: 5px; height: 100%; display: flex;
                                  align-items: center;">
                                    <span class="text-muted">
                                      {{$item->title}}
                                      {{-- Order now with eBloom --}}
                      ...
                      {{-- </div> --}}
                        <div class="px-7 mt-7 mb-0  d-none d-lg-block">
                           
                        </div>
                        {{-- <div class="border-top cart-footer" style="padding-top: 0px;">
                            <a href="{{url('/welcome')}}" class="btn btn-block btn-primary btn-lg" >
                              Παραγγελία
                            </a>
                        </div> --}}
                    </div>
