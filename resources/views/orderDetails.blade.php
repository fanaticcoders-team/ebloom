...
<script src="{{asset("frontEnd-assets/assets/ajax/libs/lazysizes/5.1.2/lazysizes.min.js")}}" async defer type="7f68c7e5cf399bdea990487a-text/javascript"></script>
    ...
    <link rel="stylesheet" href="{{asset("frontEnd-assets/assets/css/orderDetails.css")}}">
      ...
      <div class="bg-white box-shadow rounded mb-5 mb-md-7">
        <div class="px-7 pt-7 pt-lg-11 px-lg-5 pt-xl-11 px-xl-9 mb-11">
          <h2>
            ...
            {{__('words.Στοιχεία Παραγγελίας')}}

            {{-- Order Details --}}
          </h2>
          {{-- <p class="text-muted">Are you want flowers? we have it!</p> --}}
       ...
       <div class="card card-1">
                <div class="card-body">
                    <div class="row justify-content-between mb-3">
                        ...
                        {{__('words.Αριθμός Παραγγελίας')}}

                          {{-- Order No#  --}}
                          : {{$orderDetails->orderNo}}</small> </div>
                    </div>
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-8">
                                              @foreach ($products as $product)
                                                  @if ($product->id == $pro->product_id)
                                                    <div class="sq align-self-center "> <img class="img-fluid my-auto align-self-center mr-2 mr-md-4 pl-0 p-0 m-0" src="/uploads/products/{{$product->image}}" width="150" height="135" /> </div>
                                                  @endif
                                              @endforeach
                                            </div>
                                    </div>
                                    ...
                                    <div class="row">
                                                <div class="col my-auto">
                                                    <h6 class="mb-0"> {{$pro->product_name}}</h6>
                                                </div>
                                                ...
                                                <div class="col my-auto">
                                                  <small class="mb-0">
                                                    ...
                                                    {{-- Price  --}}
                                                    :
                                                     <span style="font-weight: bold"> {{$pro->product_price}}€</span></small>
                                                </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="flex-sm-col col-auto">
                                    <p class="mb-1">{{$orderDetails->coupon_amount}}</p>
                                </div>
                            </div>
                            <div class="row justify-content-between">
                                <div class="flex-sm-col text-right col">
                                ...
                                <div class="flex-sm-col col-auto">
                                    <p class="mb-1">{{$orderDetails->shipping_charges}}</p>
                                </div>
                            </div>
                            <div class="row justify-content-between">
                              ...
                              <div class="flex-sm-col col-auto">
                                  <p class="mb-1">{{$orderDetails->grand_total}}€</p>
                              </div>
                            </div>
                        </div>
                    </div>
                    <div class="row invoice ">
                        <div class="col">
                            ...
                            <p class="mb-1">
                              ...
                              {{-- Floor  --}}
                              :{{$orderDetails->floor}}</p>
                            <p class="mb-1">
                              
                              {{__('words.Όνομα στο Κουδούνι')}}

                              {{-- DoorBell Name  --}}
                              : {{$orderDetails->doorbell}}</p>
                            <p class="mb-1">
