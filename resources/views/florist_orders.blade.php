                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                 ...
                                 <span class="badge " style="background-color: rgb(204, 204, 7)"> {{$order->order_status}}</span>
                                ...
                                <td class="center">
                                    <a href="{{url('/florist/order/'.$order->id)}}"  class="btn btn-primary btn-sm">View Order Details</a><br>
                                    <a href="{{url('/admin/order-invoice/'.$order->id)}}"  class="btn btn-success btn-sm">Print Order</a>
