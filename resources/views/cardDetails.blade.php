          ...
          <div class="static-page-hero-warper position-absolute w-100 bg-white">
            <div class="col-lg-6 px-0 pl-lg-5 pr-lg-0 ml-auto h-100">
              <div class="static-page-hero bg-grey h-100 d-flex align-items-end"
                ...
                style="background-image: url('/uploads/products/{{$cardDetails['image']}}');background-size: 100% 100%;">
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-9">
                <section class="page-content page-text rounded py-11 py-lg-0 px-7 px-lg-0 mb-12 mb-lg-0">
                  ...
                  <form action="{{url(app()->getLocale().'/card-details/'.$cardDetails['name_gr'])}}" method="POST" accept-charset="utf-8" id="contact-form"
                  ...
                  {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="field-required" id="messageFormGroup">
                          <label class="d-block" for="message">
                            @if (app()->getLocale() == 'gr' )
                            Μήνυμα δώρου
                            @else
                          ...
                          <textarea data-validation="required" data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" id="message"
                            name="msg" placeholder="{{__('words.Το μήνυμά σου')}}">{{$cardDetails['msg']}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="field-required" id="messageFormGroup">
                        ...
                        <textarea data-validation="required" data-validation-error-msg="Αυτό το πεδίο είναι απαραίτητο" id="message"
                          name="comment" placeholder="{{__('words.Το μήνυμά σου')}}">{{$cardDetails['comment']}}</textarea>
                      </div>
                    </div>
                    ...
                    <br>
                    <input class="button button-primary w-50" id="contactBtn" type="submit" name="submit" value="{{__('words.Αποστολή')}}">
